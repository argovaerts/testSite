...
var AdBlockBar = function() {
  ...
  this.display = function() {
    ...
    var html = '<div id="adblock-banner" style="position: fixed; left: 0; border-bottom: 1px solid #DFDDCB; top: 0; margin: 0; width: 100%; z-index: 99999; color: rgb(111, 109, 91); padding: 0; background: none repeat scroll 0 0 rgb(255, 252, 223); text-align: left; font-size: smaller;"><a href="'+this.appUrls[this.platform]+'" style="color: rgb(79, 77, 59); text-decoration: none; padding-right: 30px; display: block;" target="_blank"><span style="display: block;  color: #fff; float: left; padding: 10px 12px 10px 8px; background: #bd695b;">&#9888; Your browser is not using an ad blocker! </span><span style="display: block; padding: 10px 10px; float: left;">This makes your browser slower and hurts your privacy. For the best web experience, you should <span style="text-decoration: underline;">install an ad blocker</span>.</span></a> <a href="" style="position: absolute; text-decoration: none; width: 12px; border: medium none; padding: 3px; top: 6px; right: 14px; color: rgb(79, 77, 59); height: 14px;" onclick="this.parentNode.style.display = \'none\'; return false">&#x2716;</a></div>';
